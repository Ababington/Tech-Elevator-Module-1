...
select payment.*, first_name, last_name, rental.return_date, film.title from payment
join customer on payment.customer_id = customer.customer_id
join rental on rental.rental_id = payment.rental_id
...
select payment.*, customer.first_name, customer.last_name, rental.return_date, film.title, actor.first_name, actor.last_name from payment
join customer on payment.customer_id = customer.customer_id
join rental on rental.rental_id = payment.rental_id
join inventory on inventory.inventory_id = rental.inventory_id
join film on inventory.film_id = film.film_id
