...
select name, population, gnp from country where gnp > 1000000 
...
select name, population from city where district ='Texas' 
...
select name, continent, gnp, lifeexpectancy from country where lifeexpectancy >= 70
